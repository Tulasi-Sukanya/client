...
//   }
// };
// paymentPagelink:https://rzp.io/l/FzcNhrGkIu
// link2:https://rzp.io/l/qAaQdQR
  return (
        ...
        <section className='py-4 container'>
          <div className='row justify-content-center'>
            ...
            <div className='col-auto'>
              ...
              <Link to="https://rzp.io/l/qAaQdQR"><button className='btn btn-primary m-2' >Checkout</button></Link>
